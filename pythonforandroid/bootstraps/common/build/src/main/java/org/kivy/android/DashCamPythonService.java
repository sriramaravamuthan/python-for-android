...
public class DashCamPythonService extends Service implements Runnable {
    ...
    private static final String PYTHON_NAME = "dashCamUploaderService";
    ...
    public static DashCamPythonService mService = null;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if ( intent != null) {
            ...
            //recreate the intent with flag and call startForeground
            Context context = getApplicationContext();
            Intent ix = DashCamPythonService.getDashCamIntent(context,
                            DashCamPythonService.class,
                            SERVICE_ENTRY_POINT,
                            PYTHON_NAME);
    ...
    public static Intent getDashCamIntent(Context context, Class serviceClass, String serviceEntrypoint, String pythonName){
        Intent ix = new Intent(context, serviceClass);
        ...
        ix.putExtra("serviceEntrypoint", serviceEntrypoint);
        ix.putExtra("pythonName", pythonName);
        ...
        Bundle extras = ix.getExtras();
        extras.putString("serviceTitle", pythonName);
        extras.putString("serviceDescription", pythonName);
